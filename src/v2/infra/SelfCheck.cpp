...
namespace DockWMac::infra
{
    ...
    int RunSelfCheck()
    {
        ...
        Check(failures, "platform.autohide.bottom", bottomHidden.width == 800 && bottomHidden.height == triggerThickness);
        Check(failures, "platform.autohide.left", leftHidden.width == triggerThickness && leftHidden.height == 800);
        Check(failures, "platform.autohide.right", rightHidden.width == triggerThickness && rightHidden.height == 800);
